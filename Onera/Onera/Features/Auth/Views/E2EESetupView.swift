        ...
        List {
            ...
            Section {
                ...
                Label {
                    ...
                    OneraIcon.securityShield.image
            ...
            Section {
                HStack {
                    ...
                    Button {
                        ...
                        (viewModel.showPassword ? OneraIcon.eyeOff.image : OneraIcon.eye.image)
                            .foregroundStyle(theme.textSecondary)
                    }
                    .buttonStyle(.plain)
                }
